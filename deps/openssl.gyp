  ...
  'targets': [
    {
      ...
      'include_dirs': [
        ...
        'openssl/openssl-configs/realized',
        'openssl/openssl',
        'openssl/openssl/include',
        'openssl/openssl/crypto',
        'openssl/openssl/crypto/asn1',
        'openssl/openssl/crypto/evp',
        'openssl/openssl-configs',
        'openssl/openssl-configs/<(OS)-<(target_arch)',
        'openssl/openssl-configs/<(OS)',
        'openssl/openssl-configs/<(target_arch)',
      ],
      ...
      'sources': [
        ...
        'openssl/openssl/crypto/pkcs7/pk7_dgst.c',
        ...
        'openssl/openssl/crypto/rand/rand_vms.c',
